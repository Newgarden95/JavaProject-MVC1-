...
/* getParameterByName함수란?(정규식: 문자열을 처리하는 방법 중의 하나로 특정한 조건의 문자를 '검색'하거나 '치환'하는 과정(파싱을 매우 간편하게 처리 할 수 있도록 하는 수단이다.)
...
<script type="text/javascript">
	var room_name = getParameterByName('room'); //현재 주소에서 room에 해당하는 부분 값만 추출해줌
	var cost = getParameterByName('cost'); //현재 주소에서 cost에 해당하는 부분 값만 추출해줌
</script>
